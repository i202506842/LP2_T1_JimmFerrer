...
public class DlgEquipoDental extends JDialog implements ActionListener {
	...
	void listar() {
		...
		String jpql ="select d from EquipoDental d";
		
		try {
			
			List <EquipoDental> lstEDental = manager.createQuery(jpql,EquipoDental.class).getResultList();
			
			for (EquipoDental equipo : lstEDental) {
			    Dentista dentista = equipo.getDentista();
			    Especialidad especialidad = dentista.getEspecialidad();

			    imprimir("Nro Equipo.......: " + equipo.getNroEquipo());
			    imprimir("Nombre Equipo....: " + equipo.getNombre());
			    imprimir("------------------------------------------");
			    imprimir("Dentista.........: " + dentista.getNombreCompleto()); 
			    imprimir("COP..............: " + dentista.getCop());
			    imprimir("Turno............: " + dentista.getTurno());
	...
	void adicionar() {
		    ...
		    EntityManager manager = JPAUtil.getEntityManager();
		    try {
		        EquipoDental equipo = new EquipoDental();
	...
	void buscar() {
		    ...
		    try {
		        Integer nroBusca = Integer.parseInt(txtNroEquipo.getText());

		        EntityManager manager = JPAUtil.getEntityManager();
		        
		      
		        EquipoDental equipo = manager.find(EquipoDental.class, nroBusca);
		        ...
		        mensajeError("Ingrese un número de equipo válido");
		    } catch (Exception e) {
	...
	void modificar() {
		    ...
		    try {
		        ...
		        try {
		            ...
		            if (manager.getTransaction().isActive()) manager.getTransaction();
